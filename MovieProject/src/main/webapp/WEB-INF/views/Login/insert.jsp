...
<body class="bg-gradient-primary" style="background-color: black;">
							...
							<form class="user" method="post">
								...
								<div class="form-group row">
									<div class="col-sm-6 mb-3 mb-sm-0">
										<select onchange="cselect()" id="select" name="gender">
											<option selected disabled hidden="">사용자의 성별을 선택해
												주세요.</option>
											<option value="남">남성</option>
											<option value="여">여성</option>
										</select> <input name="enabled" value="3" hidden="">
									</div>
								...
								<div class="form-group row">
									<div class="col-sm-6 mb-3 mb-sm-0">
										<input type="text" class="form-control form-control-user"
											id="phoneNum" name="phoneNum" placeholder="핸드폰 번호" style ="width: 530px;">
									</div>
								</div>
								...
								<div class="form-group row" style="margin-bottom: 3px">
									<div class="col-sm-6 mb-3 mb-sm-0">
										<input type="text" class="form-control form-control-user"
											id="user_id" name="user_id" onchange="return idchecked()"
											placeholder="아이디">
									</div>
									<div class="col-sm-6" style="padding-top: 10px">
										<button type="button" onclick="return idchecked()">아이디
											중복확인</button>
									</div>
								</div>
								<div class="form-group row">
									<div class="col-sm-6 mb-3 mb-sm-0" align="center">
										<span id="idchecked">아이디 중복확인을 해주세요.</span> <input
											type="hidden" name="idcheck" id="idcheck" value="unchecked">
									</div>
								</div>
								<div class="form-group row">
									<div class="col-sm-6 mb-3 mb-sm-0">
