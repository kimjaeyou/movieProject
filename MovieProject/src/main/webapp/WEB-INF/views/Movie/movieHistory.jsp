	...
	<header class="bg-dark py-5">
		<div class="container px-4 px-lg-5 my-5">
			<div class="text-center text-white">
				...
				<p class="lead fw-normal text-white-50 mb-0">내가 작성한 리뷰</p>
			</div>
		</div>
	</header>
								...
								<tr align="center">
									...
									<td>
										<form action="contentModify" method="get">
											<input name="review_id" value=${option.review_id} hidden="hidden"/>
											<input name="poster" value=${option.poster} hidden="hidden"/>
											<input name="content" value=${option.content} hidden="hidden"/>
											<input name="movieTitle" value=${option.movieTitle} hidden="hidden"/>
											<input name="score" value=${option.score} hidden="hidden"/>
											<input type="submit" value="리뷰 수정하기">
										</form>
										<form action="movieHistory" method="post">
										<input type="hidden" name="review_id" value=${option.review_id}>
